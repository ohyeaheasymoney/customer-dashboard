"""Teamed Guidance sub-tab — free-form text area for teamed accounts."""
...
class TeamedGuidanceTab(BaseSubTab):
    ...
    def _build_ui(self):
        ...
        self.make_card_header(card, "Teamed Account Guidance", [
        ...
        ctk.CTkLabel(body, text="Guidance notes for teamed accounts — "
                     "document collaboration guidelines, shared responsibilities, "
    ...
    def refresh(self):
        data = db.get_text_section(self.conn, self.customer_id, "guidance")
    ...
    def _save(self):
        ...
        messagebox.showinfo("Saved", "Teamed guidance saved.")
